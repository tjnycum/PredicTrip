...
# To change GEOMESA_HBASE_HOME and/or GEOMESA_CONF_DIR, export the desired path to the respective variable
...
# not set but GEOMESA_HBASE_HOME is, this will default to GEOMESA_HBASE_HOME/lib.
#
# setvar GEOMESA_LIB /path/to/geomesa-$VERSION/dist/tools/geomesa-tools-$VERSION/lib

# GeoMesa logs directory.
# This resides inside GeoMesa tools by default but can be moved elsewhere. If this is
# not set but GEOMESA_HBASE_HOME is, this will default to GEOMESA_HBASE_HOME/logs.
#
setvar GEOMESA_LOG_DIR /var/log/geomesa-tools/
...
# Accumulo sparkconf directory.
# This resides inside Accumulo home by default. If this is not set but ACCUMULO_HOME is,
# this will default to ACCUMULO_HOME/sparkconf.
#
# setvar ACCUMULO_CONF_DIR /path/to/accumulo/sparkconf
